...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    }
    {
      ...
      vars.put("attr", attribute);
    }

    String attr = vars.get("attr").toString();

    String baseUrl = "http://localhost:8080";
    String expectedUrl = baseUrl + "/reset";

    if (!attr.startsWith("http")) {
      attr = baseUrl + attr;
    }
    assertEquals(vars.get("attr").toString(), expectedUrl);
  }
  ...
  public void tEST3CATALOG() {
    ...
    String baseUrl = "http://localhost:8080";
    String expectedUrl = baseUrl + "/images/cat2.jpg";
